...
//    }
    ...
    private suspend fun getConvFromRefSnapshot(
        ...
        try {
            ...
            val myUser = MyUser("DUMMYUID", userFields.firstName, userFields.lastName, null)
            ...
            return Conversation(convID, myUser, lostItemName, messages.toMutableList())
        } catch (e: Exception) {
    ...
    private suspend fun getUserFieldsFromUID(uid: String): DummyUser? {
        try {
            ...
            val userIcon =
                if (userDoc.contains("user_icon")) getLocalPathToUserIcon(
                    uid,
